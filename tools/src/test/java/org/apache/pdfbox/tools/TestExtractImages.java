...
class TestExtractImages
{
    ...
    void testEmbeddedPDFs() throws Exception 
    {
        ...
        Files.copy(source.toPath(), tempPdfFile.toPath(), StandardCopyOption.REPLACE_EXISTING);
        ...
        try 
        {
            ExtractImages app = new ExtractImages();
            CommandLine cmd = new CommandLine(app);
            int exitCode = cmd.execute("--input=" + tempPdfFile.getAbsolutePath(), "-includeDensity");
        ...
        Files.delete(Paths.get(tempPdfFile.getPath()));
        Files.delete(Paths.get(resultPicture1.getPath()));
        Files.delete(Paths.get(resultPicture2.getPath()));
        Files.delete(Paths.get(resultPicture3.getPath()));
        Files.delete(Paths.get(resultPicture4.getPath()));
        Files.delete(Paths.get(resultPicture5.getPath()));
    }
